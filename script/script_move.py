...
class Initialise_robot(object):
  	...
  	def __init__(self):
	    ...
	    # rospy.init_node('script_move', anonymous=True)
	...
	def pick_object(self, x, y, z=0.23, scale=1):
		"""fonction used to pick the objects (first x,y then orientation, then z)"""
...
def main():
  try:
    ...
    raw_input()
    result = ur10.rotation(pi/2,z=0.4 )
